...
export function buildDeliveryEmailHtml({
  ...
  const attachmentBlock = attachedNote
    ? `
              <p style="margin:0 0 24px;font-family:Arial,sans-serif;font-size:15px;color:#3D4B3A;line-height:1.7;">
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#ffffff;border-radius:12px;overflow:hidden;">
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <p style="margin:0 0 8px;font-family:Arial,sans-serif;font-size:15px;color:#3D4B3A;line-height:1.7;">
                The guide includes:
              </p>
              <ul style="margin:0 0 24px;padding-left:20px;font-family:Arial,sans-serif;font-size:15px;color:#3D4B3A;line-height:1.8;">
                ${bulletsHtml}
              </ul>
              ...
              <p style="margin:0 0 12px;font-family:Arial,sans-serif;font-size:15px;color:#3D4B3A;line-height:1.7;">
              ...
              <p style="margin:0 0 32px;font-family:Arial,sans-serif;font-size:15px;line-height:1.7;">
                <a href="${videoUrl}" style="color:#C17A5C;font-weight:600;text-decoration:underline;">
              ...
              <p style="margin:0 0 32px;font-family:Arial,sans-serif;font-size:15px;line-height:1.7;">
                <a href="${programsUrl}" style="color:#C17A5C;font-weight:600;text-decoration:underline;">
                  Click here for more information on programs and offerings
                </a>
              </p>

              <p style="margin:0 0 24px;font-family:Georgia,serif;font-size:16px;color:#3D4B3A;line-height:1.7;font-style:italic;">
                Your body is home. Let’s make it feel like one.
              </p>

              <p style="margin:0;font-family:Georgia,serif;font-size:16px;color:#3D4B3A;">
                —Erin
              </p>
            </td>
          </tr>
